  ...
  return (
    <article className="max-w-none">
      <header className="mb-16 md:mb-20">
        {/* Magazine metadata */}
        {post.metadata.date && (
          <div className="text-xs uppercase tracking-[0.2em] text-gray-500 font-bold mb-8">
        ...
        <div className="space-y-6">
          ...
          {post.metadata.description && (
            <p className="text-xl text-gray-700 leading-relaxed max-w-[42rem]">
              {post.metadata.description}
            </p>
          )}
        </div>
      ...
      <div className="
        ...
        [&_li]:mb-[0.5em] [&_li]:leading-relaxed
      ">
