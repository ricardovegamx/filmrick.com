      ...
      <section className="py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-12 md:px-16 lg:px-20 xl:px-24">
          <article className="
            ...
            [&>h2]:text-2xl [&>h2]:font-bold [&>h2]:mt-12 [&>h2]:mb-6 [&>h2]:text-gray-800
            [&>h3]:text-xl [&>h3]:font-bold [&>h3]:mt-8 [&>h3]:mb-4 [&>h3]:text-gray-800
      ...
      <section className="py-16 md:py-24 border-t border-gray-100 bg-gray-50">
        <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20 xl:px-24 text-center">
          ...
          <p className="text-lg text-gray-700 mb-12 max-w-2xl mx-auto leading-relaxed">
            I&apos;d love to hear from fellow photographers, potential collaborators, or anyone interested in the art of analog photography.
          </p>
