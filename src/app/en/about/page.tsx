  ...
  if (!bio) {
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-12 md:px-16 py-24">
          ...
          <p className="text-gray-600 font-serif text-lg leading-relaxed text-center max-w-2xl mx-auto">
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-12 md:px-16 text-center">
          ...
          <div className="relative w-48 h-48 md:w-56 md:h-56 mx-auto mb-12 rounded-full bg-gray-100 border border-gray-200">
            <div className="absolute inset-0 flex items-center justify-center rounded-full">
              <span className="text-gray-400 text-sm uppercase tracking-wide font-sans">{tCommon('portraitPhoto')}</span>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 border-t border-gray-100 bg-gray-50">
        <div className="max-w-4xl mx-auto px-12 md:px-16 text-center">
          <h2 className="text-3xl md:text-4xl font-extralight text-gray-800 mb-8 font-sans">
            {t('letsConnect')}
          </h2>
          <p className="text-lg text-gray-700 mb-12 font-serif max-w-2xl mx-auto leading-relaxed">
