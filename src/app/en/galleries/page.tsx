        ...
        <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20 xl:px-24">
          {galleries.length > 0 ? (
                  ...
                  <Link href={`/galleries/${gallery.metadata.slug}`} className="block">
                    ...
                    <div className="relative aspect-[4/5] mb-6 bg-gray-100 border border-gray-200 overflow-hidden group-hover:shadow-lg transition-all duration-300">
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-gray-400 text-sm uppercase tracking-ultra-wide">Featured Image</span>
                      </div>
            ...
            <div className="text-center py-16">
              <p className="text-xl text-gray-600 mb-8">No galleries available yet.</p>
              <p className="text-gray-500">Check back soon for new collections of film photography.</p>
            </div>
          )}
        </div>
      </section>
