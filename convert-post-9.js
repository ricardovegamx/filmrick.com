...
// Post #9 specific data
const POST_ID = '164530038';
const POST_SLUG = 'photowalk-how-a-roll-from-2008-took';
const POST_NUMBER = 9;
...
async function convertPost() {
  ...
  // Create English MDX
  const englishMdx = `---
title: "Photowalk: How a Roll from 2008 Took 16 Years to Develop"
description: "The incredible story of a forgotten roll of film that sat undeveloped for over a decade, and the magical results when it finally saw the light of day."
date: "2025-02-01"
---
...
`;
  ...
  const spanishContent = content
    .replace(/## The Forgotten Roll/g, '## El Rollo Olvidado')
    .replace(/## The Long Wait/g, '## La Larga Espera')
    .replace(/## Finally Developed/g, '## Finalmente Revelado')
    .replace(/## The Results/g, '## Los Resultados')
    .replace(/## Lessons Learned/g, '## Lecciones Aprendidas');
